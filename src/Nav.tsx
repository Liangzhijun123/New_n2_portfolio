...
const NavBar = () => {
  return (
    <>
      <div className="">
        <div className="bg-[#31468461] w-full h-[91px] p-4 md:px-10 shadow-nav fixed z-10">
      ...
      <div className="flex flex-row gap-4 md:gap-10 justify-between w-[200px] md:w-[390px] mt-28 fixed px-5 md:px-10">
